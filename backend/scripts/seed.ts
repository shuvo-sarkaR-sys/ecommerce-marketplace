...
const DEMO_IMAGES: Record<CategorySlug, string> = {
  women: "https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=900&q=85",
  men: "https://images.unsplash.com/photo-1617127365659-c47fa864d8bc?auto=format&fit=crop&w=900&q=85",
  ...
  for (const { brand, seller, categorySlug } of brandDocs) {
    ...
    for (const template of templates) {
      const product = await Product.create({
        ...
        images: [DEMO_IMAGES[categorySlug]],
